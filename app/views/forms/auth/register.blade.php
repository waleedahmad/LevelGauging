				...
				<div class="form">
					...
					<form class="fields">
						<div class="formfields">
							<input class="credentials" type="text" name="email" placeholder="Email">
						</div>
						<div class="formfields">
						...
						<div class="button">
							...
							<g>
								...
								<g>
									...
									<text transform="matrix(1 0 0 1 41.7245 23.4292)" fill="#FFFFFF" font-size="15.8237">Register</text>
								</g>
							...
							<!-- <input type="submit" class="submit" value="Connect" name="submit"> -->
						</div>
					</form>
